> I am using the starter because it is a lot faster. It also provides nice, simple, and clean layout. Below is the original README file from the template. - Riordan
